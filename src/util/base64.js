...
var r = (t = t || {}).Base64, e = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/", n = function (t) {
    ...
    var r = t.length, e = r % 4,
        c = (r > 0 ? n[t.charAt(0)] << 18 : 0) | (r > 1 ? n[t.charAt(1)] << 12 : 0) | (r > 2 ? n[t.charAt(2)] << 6 : 0) | (r > 3 ? n[t.charAt(3)] : 0),
        a = [o(c >>> 16), o(c >>> 8 & 255), o(255 & c)];
